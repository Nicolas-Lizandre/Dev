...
--------------------------------- Si erreur (à moins caractères juste faux), ne pas chercher la bête en bas
                ...
                when FrequencyTooHigh =>
                    ...
                    -- "329,6HZ > ---HZ DESSUS CORDE 6"
                    data_to_be_send(write_index) <= x"33"; write_index <= write_index + 1; -- 3
                    data_to_be_send(write_index) <= x"32"; write_index <= write_index + 1; -- 2
                    data_to_be_send(write_index) <= x"39"; write_index <= write_index + 1; -- 9
                    data_to_be_send(write_index) <= x"2C"; write_index <= write_index + 1; -- ,
                    data_to_be_send(write_index) <= x"36"; write_index <= write_index + 1; -- 6
                    data_to_be_send(write_index) <= x"48"; write_index <= write_index + 1; -- H
                    data_to_be_send(write_index) <= x"5A"; write_index <= write_index + 1; -- Z
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1; -- space
                    data_to_be_send(write_index) <= x"3E"; write_index <= write_index + 1; -- >
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;

                    -- "---HZ"
                    data_to_be_send(write_index) <= x"2D"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"2D"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"2D"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"48"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"5A"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;

                    -- "DESSUS"
                    data_to_be_send(write_index) <= x"44"; write_index <= write_index + 1; -- D
                    data_to_be_send(write_index) <= x"45"; write_index <= write_index + 1; -- E
                    data_to_be_send(write_index) <= x"53"; write_index <= write_index + 1; -- S
                    data_to_be_send(write_index) <= x"53"; write_index <= write_index + 1; -- S
                    data_to_be_send(write_index) <= x"55"; write_index <= write_index + 1; -- U
                    data_to_be_send(write_index) <= x"53"; write_index <= write_index + 1; -- S
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                ...
                when FrequencyTooLow =>
                    ...
                    data_to_be_send(write_index) <= x"5A"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"3C"; write_index <= write_index + 1; -- <
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;

                    -- "82,4HZ"
                    data_to_be_send(write_index) <= x"38"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"32"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"2C"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"34"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"48"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"5A"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1; -- double espace volontaire

                    -- "DESSOUS"
                    data_to_be_send(write_index) <= x"44"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"45"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"53"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"53"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"4F"; write_index <= write_index + 1; -- O
                    data_to_be_send(write_index) <= x"55"; write_index <= write_index + 1; -- U
                    data_to_be_send(write_index) <= x"53"; write_index <= write_index + 1; -- S
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                ...
                when Corde_1_Pos  =>
                    ...
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"2B"; write_index <= write_index + 1; -- '+'
                    ...
                    write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"25"; write_index <= write_index + 1;
                ...
                when Corde_2_Pos =>
                    ...
                    data_to_be_send(write_index) <= x"45"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"35"; write_index <= write_index + 1;

                    data_to_be_send(write_index) <= x"00";
                    state <= Instruction_Transmission;
                
                when Corde_2_Neg =>                     -- "246.9Hz SI -"
                    data_to_be_send(write_index) <= x"32"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"34"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"36"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"2E"; write_index <= write_index + 1;
                ...
                when Corde_3_Pos =>
                    ...
                    data_to_be_send(write_index) <= x"36"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"2E"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"30"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"48"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"5A"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"53"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"4F"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"4C"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"2B"; write_index <= write_index + 1;
                ...
                when Corde_4_Pos =>
                    ...
                    data_to_be_send(write_index) <= x"36"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"2E"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"37"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"48"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"5A"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"52"; write_index <= write_index + 1; -- R
                    data_to_be_send(write_index) <= x"45"; write_index <= write_index + 1; -- E
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"2B"; write_index <= write_index + 1; -- '+'
                    ...
                    -- "CORDE 4 CASE 5"
                    data_to_be_send(write_index) <= x"43"; write_index <= write_index + 1; -- C
                    data_to_be_send(write_index) <= x"4F"; write_index <= write_index + 1; -- O
                    data_to_be_send(write_index) <= x"52"; write_index <= write_index + 1; -- R
                    data_to_be_send(write_index) <= x"44"; write_index <= write_index + 1; -- D
                    data_to_be_send(write_index) <= x"45"; write_index <= write_index + 1; -- E
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"34"; write_index <= write_index + 1; -- 4
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"43"; write_index <= write_index + 1; -- C
                    data_to_be_send(write_index) <= x"41"; write_index <= write_index + 1; -- A
                    data_to_be_send(write_index) <= x"53"; write_index <= write_index + 1; -- S
                    data_to_be_send(write_index) <= x"45"; write_index <= write_index + 1; -- E
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"35"; write_index <= write_index + 1; -- 5
                ...
                when Corde_5_Pos =>
                    ...
                    data_to_be_send(write_index) <= x"5A"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"4C"; write_index <= write_index + 1; -- L
                    data_to_be_send(write_index) <= x"41"; write_index <= write_index + 1; -- A
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"2B"; write_index <= write_index + 1; -- '+'
                ...
                when Corde_6_Pos =>
                    ...
                    data_to_be_send(write_index) <= x"5A"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"4D"; write_index <= write_index + 1; -- M
                    data_to_be_send(write_index) <= x"49"; write_index <= write_index + 1; -- I
                    data_to_be_send(write_index) <= x"20"; write_index <= write_index + 1;
                    data_to_be_send(write_index) <= x"2B"; write_index <= write_index + 1;
