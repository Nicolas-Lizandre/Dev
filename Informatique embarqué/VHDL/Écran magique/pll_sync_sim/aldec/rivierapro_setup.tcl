...
# ACDS 24.1 1077 win32 2025.11.20.10:30:23
# ----------------------------------------
...
# ----------------------------------------
# If pll_sync is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_sync.vho"
}
